...
import org.firstinspires.ftc.teamcode.subsystems.lift.ARESLift;
...
@TeleOp
//@Disabled
public class ARESLiftTest extends OpMode {
    ARESLift lift;
    ...
    public void init() {
        ...
        lift = new ARESLift(new Motor(0, "slides1", hardwareMap, false), new Motor(0, "slides2", hardwareMap, false), hardwareMap.voltageSensor.iterator().next());
    }
